...
export default function ServicesBot() {
    ...
    const servicesFAQs = [
        "How many kinds of scholarships?",
    ...
    const [chatLog, setChatLog] = useState<ChatLogItem[]>([
        { type: 'bot', message: 'Ask me anything about the public administration of Hanoi University.' }
    ]);
    ...
    const clearChat = () => {
        ...
        // if (chatLog.length > 1) {
        setChatLog([{ type: 'bot', message: 'Ask me anything about the public administration of Hanoi University.' }]);
    ...
    async function fetchDocuments(question: string) {
        const url = 'http://localhost:8080/hanu-chatbot/public-administration';
        try {
